...
| --- | --- | --- | --- |
| `pkg/dbconn` — pool defaults, terminate-blockers, retries, RDS TLS, advisory table lock | ✅ core | exists | LK-1; LK-2 primitives; CO-9 (session hook and `LocalSearchPath`) |
