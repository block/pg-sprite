...
| table name (copy-and-swap target) | copy-and-swap preflight | `CopySwapTarget` (carries the integer PK and the owner role that shadow objects are created under) | ST-6 for copy-and-swap |
