...
| [refusal-classes.md](refusal-classes.md) | The **refusal routing contract** — the four machine-readable classes above existing reasons, the owner vocabulary for work outside an online engine, the complete reason-to-class map, and the proof-type enforcement that makes an unclassified refusal unrepresentable. |
